...
type Supplier = { _id: string; name: string; contactPerson?: string; phone?: string; email?: string; address?: string };
...
export default function Suppliers() {
  ...
  const load = () => {
    setLoading(true);
    api
      .get<{ success: boolean; data: { items: Supplier[] } }>('/suppliers?limit=200')
      .then((r) => {
  ...
  return (
    <>
      ...
      <Modal title="Add Supplier" open={modalOpen} onCancel={() => setModalOpen(false)} footer={null} destroyOnClose>
